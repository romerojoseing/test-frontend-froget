...
_This is a challenge from testing, specialized in frontend develop, application where the Star Wars API is consumed and applied._

## [Try the live demo](https://romerojoseing.github.io/test-frontend-froget/) ⚡
...
```ssh
  $ git clone https://github.com/romerojoseing/test-frontend-froget.git
```
